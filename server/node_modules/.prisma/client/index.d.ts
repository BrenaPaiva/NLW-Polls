...
export namespace Prisma {
  ...
  */
  ...
  export type UserSelect = {
    ...
    avatarUrl?: boolean
    createdAt?: boolean
    participatingAt?: boolean | ParticipantFindManyArgs
  ...
  export type UserGetPayload<
    ...
    ? User  & {
    [P in TrueKeys<S['include']>]:
        P extends 'participatingAt' ? Array < ParticipantGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
    ...
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'participatingAt' ? Array < ParticipantGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
  ...
  export class Prisma__UserClient<T, Null = never> implements PrismaPromise<T> {
    ...
    participatingAt<T extends ParticipantFindManyArgs = {}>(args?: Subset<T, ParticipantFindManyArgs>): CheckSelect<T, PrismaPromise<Array<Participant>| Null>, PrismaPromise<Array<ParticipantGetPayload<T>>| Null>>;
