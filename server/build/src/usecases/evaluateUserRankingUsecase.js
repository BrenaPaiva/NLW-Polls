...
exports.EvaluateUserRankingUseCase = void 0;
const rules = [
    [
        function match(attemp) {
            ...
            if (attemp.guessSubmission.firstTeamPoints === attemp.gameResult.firstTeamPoints &&
    ...
    [
        function winnerScore(attemp) {
            ...
            if (attemp.guessSubmission.secondTeamPoints === attemp.gameResult.secondTeamPoints &&
...
class EvaluateUserRankingUseCase {
    static execute(data) {
        const evaluatedData = data.map((dataItem) => {
            let score = 0;
...
exports.EvaluateUserRankingUseCase = EvaluateUserRankingUseCase;
